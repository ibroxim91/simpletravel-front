  ...
  return (
    <div className="w-full">
      <div className="w-full bg-[#FFFFFF] p-[20px] rounded-[20px] relative">
        <p className="text-2xl font-bold">Оплата</p>
        ...
        <div className="flex my-5 justify-between flex-col items-start gap-2 bg-[#EDEEF180] p-[20px] rounded-[20px] border-2 border-[#EDEEF180]">
          <h1 className="text-2xl font-bold">+22 450 000 сум</h1>
          <p className="text-[#050B08] font-medium">Общая сумма</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-[20px] mt-2 max-lg:grid-cols-1">
          ...
          >
            <div className="flex items-center gap-[20px]">
              ...
              <p className="text-xl font-bold">Uzum bank</p>
            </div>
            <input
              type="radio"
              id="payment-payme"
          ...
          >
            <div className="flex items-center gap-[20px]">
              ...
              <p className="text-xl font-bold">Payme</p>
            </div>
            <input
              type="radio"
              id="payment-uzum"
      ...
      <div className="w-full bg-[#FFFFFF] p-[20px] rounded-[20px] mt-5">
        <div className="flex items-center justify-between max-lg:flex-col max-lg:gap-4 max-lg:items-start">
          <h1 className="text-2xl font-bold">Подробности заказа</h1>
          <button className="flex items-center gap-[10px] cursor-pointer px-[15px] py-[10px] border-2 rounded-full border-[#DFDFDF] max-lg:w-full justify-center hover:bg-gray-50 transition-colors">
            ...
            <p className="text-[#031753] font-semibold text-lg">Скачать PDF</p>
          </button>
        </div>

        <h1 className="mt-5 text-lg font-bold">Дата</h1>
        <div className="grid grid-cols-2 w-full my-2 bg-[#EDEEF1] px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Откуда</p>
        ...
        <div className="grid grid-cols-2 items-center justify-between w-full my-2 bg-[#EDEEF1] px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Время вылета</p>
      ...
      ${index % 2 === 0 ? 'bg-[#EDEEF1]' : 'bg-white'}`}
        ...
        <h1 className="mt-5 text-lg font-bold">Турпакет</h1>
        <div className="grid grid-cols-2 items-center justify-between w-full my-2 bg-[#EDEEF1] px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Отель</p>
          <p className="!text-black text-end break-words">Memories Varadero</p>
        </div>

        <div className="grid grid-cols-2 items-center justify-between w-full my-2 px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Локация</p>
          <p className="!text-black text-end break-words">ОАЭ, Шарджа</p>
        </div>

        <div className="grid grid-cols-2 items-center justify-between w-full my-2 bg-[#EDEEF1] px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Рейтинг</p>
          <p className="!text-black text-end break-words">4/5 звёзды</p>
        </div>

        <div className="grid grid-cols-2 items-center justify-between w-full my-2 px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md break-words">Характеристики</p>
          <p className="!text-black text-end break-words">
            Открытый бассейн, Анимация, Первая линия пляжа
          </p>
        </div>

        <div className="grid grid-cols-2 items-center justify-between w-full my-2 bg-[#EDEEF1] px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Тип пакета</p>
          <p className="!text-black text-end break-words">
        ...
        <div className="grid grid-cols-2 items-center justify-between w-full my-2 px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Транспорт</p>
          <p className="!text-black text-end break-words">
            {TransportOptions.find((e) => e.id === transport)?.label}
          </p>
        </div>

        <h1 className="mt-5 text-lg font-bold">Услуги</h1>
        <div className="grid grid-cols-2 items-center justify-between w-full my-2 bg-[#EDEEF1] px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Городская экскурсия</p>
          <p className="!text-black text-end break-words">+1 450 000 сум</p>
        </div>

        <div className="grid grid-cols-2 items-center justify-between w-full my-2 px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Поездка на пляж</p>
          <p className="!text-black text-end break-words">+1 450 000 сум</p>
        </div>
        ...
        <h1 className="mt-5 text-lg font-bold">Дополнительные услуги</h1>
        <div className="grid grid-cols-2 items-center justify-between w-full my-2 bg-[#EDEEF1] px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Страховка</p>
          <p className="!text-black text-end break-words">+1 450 000 сум</p>
        </div>

        <div className="grid grid-cols-2 items-center justify-between w-full my-2 px-[8px] py-[5px] rounded-[8px] text-[#646465]">
          <p className="text-md">Визовая поддержка</p>
          <p className="!text-black text-end break-words">+1 450 000 сум</p>
        </div>
      </div>

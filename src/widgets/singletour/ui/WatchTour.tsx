    ...
    >
      <div className="relative w-full max-w-full md:max-w-5xl lg:max-w-6xl">
        ...
        <button
          aria-label="Close"
          onClick={onClose}
          className="absolute right-3 top-3 md:-right-6 md:-top-6 lg:-right-8 lg:-top-8 cursor-pointer z-[1001] bg-white/90 hover:bg-white text-black rounded-full p-2 md:p-2.5 shadow focus:outline-none focus:ring-2 focus:ring-white/80"
        >

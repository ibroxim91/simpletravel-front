      ...
      {isLoading ? (
        ...
        >
          ...
          >
            {ticket && ticket[0] && (
              <Link
                href={`/selectour/${ticket[0].slug}/?departure=${ticket[0].departure_id}&destination=${ticket[0].destination_id}&adults=${ticket[0].adults}&operator=${ticket[0].operator}`}
          ...
          <div className="grid grid-rows-2 w-full gap-4">
            <div className="w-full flex h-full rounded-3xl gap-4">
              ...
              >
                {ticket && ticket[1] && (
                  <Link
                    href={`/selectour/${ticket[1].slug}/?departure=${ticket[1].departure_id}&destination=${ticket[1].destination_id}&adults=${ticket[1].adults}&operator=${ticket[1].operator}`}
                    prefetch={true}
                    onClick={() => {
              ...
              >
                {ticket && ticket[2] && (
                  <Link
                    href={`/selectour/${ticket[2].slug}/?departure=${ticket[2].departure_id}&destination=${ticket[2].destination_id}&adults=${ticket[2].adults}&operator=${ticket[2].operator}`}
                    prefetch={true}
                    onClick={() => {
            ...
            <div className="w-full flex h-full rounded-3xl gap-4">
              ...
              >
                {ticket && ticket[3] && (
                  <Link
                    href={`/selectour/${ticket[3].slug}/?departure=${ticket[3].departure_id}&destination=${ticket[3].destination_id}&adults=${ticket[3].adults}&operator=${ticket[3].operator}`}
                    prefetch={true}
                    onClick={() => {
              ...
              >
                {ticket && ticket[4] && (
                  <Link
                    href={`/selectour/${ticket[4].slug}/?departure=${ticket[4].departure_id}&destination=${ticket[4].destination_id}&adults=${ticket[4].adults}&operator=${ticket[4].operator}`}
                    prefetch={true}
                     onClick={() => {

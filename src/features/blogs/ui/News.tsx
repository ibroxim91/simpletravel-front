...
const News = () => {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () =>
      News_Api.getAllNews({
        page: currentPage,
        category: initialTab ? Number(initialTab) : '',
        page_size: 9,
      }),
    select(data) {
      return data.data;
      ...
      >
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 w-full text-center">
            ...
            />
            <p className="text-xl font-semibold text-[#031753] mb-2">
              {t('Yangiliklar topilmadi')}
            </p>
            <p className="text-[#646465] text-base max-w-md">

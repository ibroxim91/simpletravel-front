...
declare const messages: {
  ...
  'Необходимые документы: загранпаспорт (действителен минимум 6 месяцев), фото, анкета, медицинская страховка': 'Kerakli hujjatlar: xorijiy pasport (kamida 6 oy amal qilishi kerak), foto, anketа, tibbiy sug‘urta';
  ...
  'Фото/скан паспорта': 'Pasport fotosi/skani';
  ...
  '2025 © Все права защищены': '20.25 © Barcha huquqlar himoyalangan.';
  ...
  'Введите 5-значный код, который мы только что отправили на': 'Biz hozirgina yuborgan 5 xonali kodni kiriting';

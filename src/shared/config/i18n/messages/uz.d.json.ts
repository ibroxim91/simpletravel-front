...
declare const messages: {
  ...
  "Войти": "Kirish",
  "Oʻzbekcha": "Oʻzbekcha",
  "accept_offerta": "Ommaviy oferta shartlariga roziman",
  ...
  "Noyabr": "noyabr",
  "Dekabr": "dekabr",
  "Проживание": "Yashash joyi",
  "Авиаперелёт": "Avia parvoz",
  "24/7 техподдержка": "24/7 texnik yordam",
  "FB": "To‘liq pansion",
  "BB": "Nonushta",
  "HB": "Yarim pansion",
  "AI": "Hammasi kiritilgan",
  "UAI": "Hammasi kiritilgan",
  "RO": "Ovqatlanishsiz",
  ...
  "Количество": "Sayohotchilar",
  "Дата тура": "Tur sanalari",
  "Информация о номере": "Xona ma'lumotlari",
  "Филтры": "Filtrlar",
  "Qiziqarli joylar": "Qiziqarli joylar",
  "еще": "yana",
  "Отзывы о гостинице": "Mexmonxona xaqida fikrlar",
  "Отзывы": "Bildirilgan fikrlar",
  "Отзывы нашых клиентов": "Mijozlarimiz  fikrlar",
  "Mexmonxona xonalari": "Mexmonxona xonalari",
  "Преимущества отеля размещения:": "Mehmonxona qulaylik va xizmatlari",
  "Тип размещения": "Joylashuv turi",
  "Категория номера": "Xona kategoriyasi",
  "Hайдено": "Topildi",
  ...
  "человек": "kishi",
  "человека": "kishi",
  "default_hotel_description": "Bizning mehmonxonalarimiz sifatli xizmat, tajribali va e’tiborli personal, toza va shinam xonalar hamda qulay dam olish uchun keng imkoniyatlarni taqdim etadi. Siz bu yerda osoyishta muhit, mazali taomlar va zamonaviy sharoitlardan bahramand bo‘lasiz.",
  "Языки": "Tillar",
  "Найдено": "Topildi",
  ...
  "reviews_subtitle": "Haqiqiy taassurotlar va Simple Travel bilan sayohat qilgan mijozlar",
  "video_reviews_title": "Sayohatchilarimiz videolari",
  "video_reviews_subtitle": "Mijozlarimiz sayohatlari haqidagi qisqa videolar",
  "video_reviews_all": "Barcha video sharhlar",
  "video_reviews_swipe": "Keyingi video uchun suring",
  ...
  "Лучшие цены": "Eng yaxshi narxlar",
  "Гарантируем самые выгодные предложения на рынке": "Bozordagi eng yaxshi takliflarni berish kafolati",
  "Поддержка 24/7": "24/7 qoʻllab-quvvatlash",
  "Всегда на связи, чтобы помочь вам в любое время": "Istalgan vaqtda sizga yordam berish uchunaloqadamiz",
  "Проверенные туры": "Tekshirilgan turlar",
  "Работаем только с надежными туроператорами": "Faqat ishonchli tur operatorlar bilan ishlaymiz",
  "Полный комфорт": "To‘liq qulaylik",
  "Быстрое бронирование": "Tezkor bron qilish",
  "Оформите тур всего за несколько минут": "Bir necha daqiqalar ichida turni bronlang",
  "Почему выбирают нас": "Nima uchun bizni tanlashadi",
  "Мы делаем путешествия простыми и доступными": "Biz sayohatlarni oson va qulay qilamiz",
  "Как это работает": "Bu qanday ishlaydi",
  "how_it_works_badge": "Bu qanday ishlaydi",
  "how_it_works_title": "Sayohat endi yanada oson!",
  "how_it_works_subtitle": "Bir necha oddiy qadam bilan orzularingizdagi sayohatga chiqing",
  "how_it_works_step1_title": "Qidiruv",
  "how_it_works_step1_desc": "O'zingiz uchun kerakli turni toping",
  "how_it_works_step2_title": "Onlayn bron",
  "how_it_works_step2_desc": "Yoqtirgan turni bronlang",
  "how_it_works_step3_title": "Tasdiqlash",
  "how_it_works_step3_desc": "Operator siz bilan bog'lanib tasdiqlaydi",
  "how_it_works_step4_title": "Bilet va xujjatlarni oling",
  "how_it_works_step4_desc": "Shaxsiy kabinet yoki Telegram orqali bilet, vaucher va xujjatlarni oling",
  "hot_promo_title": "Qaynoq turlar",
  "hot_promo_from_tashkent": "Toshkentdan",
  "why_choose_title_before": "Sayohat qilish endi",
  "why_choose_title_highlight": "yanada oson",
  "why_choose_subtitle": "Sizning unutilmas sayohatingiz uchun biz har doim yoningizdamiz",
  "why_choose_price_desc": "Bozordagi eng yaxshi takliflar va maxsus chegirmalar faqat bizda.",
  "why_choose_support_desc": "Savollaringiz boʻlsa, biz har doim aloqadamiz. Har qanday masalada yordam beramiz.",
  "why_choose_verified_desc": "Faqat ishonchli hamkorlar va sinovdan oʻtgan tur operatorlari bilan ishlaymiz.",
  "why_choose_booking_desc": "Orzuingizdagi turni bir necha daqiqada bron qiling va sayohatga tayyorlaning!",
  "Три простых шага до путешествия мечты": "Orzu safaringizga uch qadam",
  "Выберите направление": "Yo‘nalishni tanlang",
  "Укажите место, даты и количество туристов в форме поиска": "Qidiruv shaklida joy, sanalar va turistlar sonini kiriting",
  "Сравните предложения": "Takliflarni solishtiring",
  "Посмотрите варианты от разных туроператоров и выберите лучший": "Turli operatorlarning variantlarini ko‘rib chiqing va eng yaxshisini tanlang",
  "Забронируйте онлайн": "Onlayn bron qiling",
  "Оформите бронирование за пару минут и получите подтверждение": "Bir necha daqiqada bron qiling va tasdiqni oling",
  "Туристическое агентство из Ташкента (Узбекистан)": "Toshkent (O‘zbekiston)dan turistik agentlik",
  "Связаться с оператором:": "Operator bilan bog‘lanish:",
  "Адрес:": "Manzil:",
  ...
  "Мы в социальных сетях:": "Biz ijtimoiy tarmoqlarda:",
  ...
  "Смотреть все туры": "Barcha turlarni ko'rish",
  "Места, в которые влюбляются": "Bu joylarni sevib qolasiz",
  "Виза не нужна": "Viza kerak emas",
  "Путешествуйте без лишних хлопот": "Ortiqcha qiyinchiliksiz sayohat",
  "Горящие туры: успейте забронировать!": "Qaynoq turlar: Band qilishga ulguring!",
  "Лучшие направления по минимальным ценам": "Eng yaxshi yo'nalishlar minimal narxlarda",
  ...
  "installment_pick": "O‘zingizga qulay muddatni tanlang",
  "price_total_label": "Umumiy narx",
  "price_start_payment": "Boshlang‘ich to‘lov",
  "price_per_month_unit": "so‘m/oy",
  "pay_safe_title": "Xavfsiz to‘lov",
  "pay_safe_desc": "Ma’lumotlaringiz himoyalangan",
  "pay_support_title": "24/7 qo‘llab-quvvatlash",
  "pay_support_desc": "Har doim siz bilan",
  "pay_fast_title": "Tez tasdiqlash",
  "pay_fast_desc": "Bir necha daqiqada",
  "passport_required": "Pasport rasmini yuklang",
  "telegram_docs_checkbox": "Boshqa ishtirokchilar xujjatlarini telegram orqali yuboraman",
  "telegram_docs_subtitle": "Operatorimiz o'zi siz bilan bo'g'lanib telegram orqali xujjatlarni so'raydi",
  "О туре кратко": "Tur haqida qisqacha",
  "звездочный": "yulduzli",
  "tour_adults": "kattalar",
  "tour_flight_title": "Aviabilet kiritilgan",
  "tour_flight_desc": "Toshkentdan uchish",
  "tour_transfer_desc": "Kirish va chiqish",
  "tour_insurance_desc": "Tibbiy sug'urta",
  "tour_support_title": "Qo'llab-quvvatlash",
  "tour_support_desc": "24/7 siz bilan"
};
